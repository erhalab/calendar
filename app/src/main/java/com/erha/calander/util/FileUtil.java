...
public class FileUtil {
    public static String getFilePathByUri(Context context, Uri uri) {
        ...
        if (ContentResolver.SCHEME_CONTENT.equals(uri.getScheme()) && false) {
...
//         */
//        uri = FileProvider.getUriForFile(MainActivity,  "com.xinmang.videoeffect.fileprovider", new File(path));
//
//        return uri;
//    }
