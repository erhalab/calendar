...
import com.erha.calander.databinding.ActivityImportClassSystemBinding
...
class ImportClassSystemActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityImportClassSystemBinding
    ...
    private fun askSemester() {
        ...
        i.toArray(array)
        //需要用户设置学期
        XPopup.Builder(this@ImportClassSystemActivity)
            ...
            .asCenterList(
                ...
                XPopup.Builder(this@ImportClassSystemActivity)
                    ...
                    .asCustom(ImportClassHelpPopup(this@ImportClassSystemActivity))
                    .show()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityImportClassSystemBinding.inflate(layoutInflater)
                    ...
                    if (isClassPage) {
                        ...
                        binding.webview.evaluateJavascript(
                            ...
                            value.apply {
                                ...
                                MessageDialogBuilder(this@ImportClassSystemActivity)
                                    .setTitle("⚠️提醒")
