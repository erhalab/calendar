...
class WeekView @JvmOverloads constructor(
    ...
    fun scrollToDateTime(dateTime: Calendar) {
        ...
        internalScrollToDate(localeDate) {
            Log.e("scrollToTime", it.hour.toString() + ":" + it.minute.toString())
    ...
    fun scrollToTime(hour: Int, minute: Int) {
        ...
        Log.e("scrollToTime", "minHour = $minHour ,maxHour = $maxHour")
        var sanitizedHour = hour.coerceIn(minimumValue = minHour, maximumValue = maxHour)
        sanitizedHour -= (minHour + 1 + 1)
    ...
    @PublicApi
    fun setCustomFirstWeekEnable(enable: Boolean) {
        viewState.customFirstWeekEnable = enable
        invalidate()
    }

    @PublicApi
    fun setWeekNumber(firstWeekCalendar: Calendar) {
        viewState.firstWeekCalendar = firstWeekCalendar
        viewState.customFirstWeekEnable = true
        invalidate()
    }
